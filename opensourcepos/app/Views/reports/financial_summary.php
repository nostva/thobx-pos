...
<div class="max-w-2xl mx-auto mt-6 animate-in fade-in slide-up">
    ...
    <!-- Report Card -->
    <div
        class="bg-white rounded-xl shadow-lg border border-slate-200 overflow-hidden print:shadow-none print:border-none">
        ...
        <!-- Print Footer -->
        <div class="bg-slate-50 p-4 text-center text-sm text-slate-400 print:hidden">
            <?= date('d/m/Y H:i') ?>
        </div>
    </div>
</div>
