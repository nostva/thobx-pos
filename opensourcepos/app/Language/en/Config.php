...
return [
    ...
    "barcode_tooltip" => "Warning: This feature can cause duplicate products to be imported or created. Do not use if you do not want duplicate barcodes.",
    ...
    "default_item_columns" => "Default Visible Product Columns",
    ...
    "derive_sale_quantity_tooltip" => "If checked then a new product type will be provided for products ordered by extended amount",
    "dinner_table" => "Table",
    ...
    "multi_pack_enabled" => "Multiple Packages per Product",
    ...
    "timezone" => "Timezone",
    "timezone_error" => "System Timezone is Different from your Local Timezone.",
    "top" => "Top",
