...
return [
    ...
    "check_balance" => "Bank transaction remainder",
    "check_filter" => "Bank transaction",
    "close" => "",
    "comment" => "Comment",
    "comments" => "Comments",
    "company_name" => "",
    ...
    "employee" => "Employee",
    "entry" => "Entry",
    "error_editing_item" => "Error editing product",
    "find_or_scan_item" => "Find or Scan Product",
    "find_or_scan_item_or_receipt" => "Find or Scan Product or Receipt",
    "giftcard" => "Gift Card",
    ...
    "item_insufficient_of_stock" => "Product has insufficient stock.",
    "item_name" => "Product Name",
    "item_number" => "Product #",
    "item_out_of_stock" => "Product is out of stock.",
    ...
    "key_in" => "Zoom in",
    "key_item_search" => "Product Search",
    "key_out" => "Zoom Out",
    ...
    "no_filter" => "All",
    "no_items_in_cart" => "There are no Products in the cart.",
    ...
    "quantity" => "Quantity",
    "quantity_less_than_reorder_level" => "Warning: Desired Quantity is below Reorder Level for that Product.",
    "quantity_less_than_zero" => "Warning: Desired Quantity is insufficient. You can still process the sale, but audit your inventory.",
    "quantity_of_items" => "Quantity of {0} Products",
    "quote" => "Quote",
    ...
    "start_typing_item_name" => "Start typing Product Name or scan Barcode...",
    "stock" => "Stock",
    ...
    "unable_to_add_item" => "Product add to Sale failed",
    ...
    "sale_items_list" => "Sale Items List",
    ...
    "close_dialog" => "Close",
    "rename_category_success" => "Category renamed successfully",
    "rename_category_error" => "Failed to rename category",
