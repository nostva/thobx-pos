...
return [
    ...
    "barcode_tooltip" => "تحذير: قد تؤدي هذه الميزة إلى استيراد منتجات مكررة أو إنشاؤها. لا تستخدمها إذا كنت لا تريد الباركود مكررة.",
    ...
    "derive_sale_quantity_tooltip" => "إذا تم تحديدها، فسيتم توفير نوع جديد من المنتجات للمنتجات المطلوبة حسب المبلغ الموسع",
    "dinner_table" => "طاولة",
    ...
    "multi_pack_enabled" => "رزم متعددة لكل منتج",
    ...
    "os_timezone" => "المنطقة الزمنية:",
    "ospos_info" => "معلومات التثبيت",
    ...
    "receiving_calculate_average_price" => "حساب متوسط سعر المنتجات المستلمة",
    ...
    "timezone_error" => "تختلف منطقة النظام الزمنية عن منطقتك الزمنية المحلية.",
    "top" => "علوى",
