...
return [
    ...
    "item" => "Product",
    "item_count" => "Filter Product Count",
    "item_name" => "Product Name",
    "item_number" => "Barcode",
    "items" => "Products",
    "items_purchased" => "Products Purchased",
    "items_received" => "Products Received",
    "items_summary_report" => "Products Summary Report",
    ...
    "name" => "Name",
    "no_reports_to_display" => "No Products to display.",
