...
<fieldset id="item_basic_info" class="flex flex-col gap-2">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
        ...
        <div class="form-group w-full">
            <?= form_label(lang('Items.category'), 'category', ['class' => 'label text-sm font-medium text-slate-700 mb-1 block required text-start']) ?>
            <div class="relative">
                <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none text-slate-400">
                ...
                if ($config['category_dropdown']) {
                    echo form_dropdown('category', $categories, $selected_category, ['class' => 'flex h-10 w-full rounded-md border border-slate-300 bg-white ps-10 pe-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 text-start']);
                } else {
                    echo form_input([
                        'name' => 'category',
                        'id' => 'category',
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
        ...
        <div class="form-group w-full">
            <?= form_label(lang('Items.stock_type'), 'stock_type', !empty($basic_version) ? ['class' => 'label text-sm font-medium text-slate-700 mb-2 block required text-start'] : ['class' => 'label text-sm font-medium text-slate-700 mb-2 block text-start']) ?>
    ...
    <div class="form-group w-full md:col-span-2">
        <?= form_label(lang('Items.supplier'), 'supplier', ['class' => 'label text-sm font-medium text-slate-700 mb-1 block text-start']) ?>
    ...
    <div class="form-group w-full md:col-span-2">
        ...
        <div class="fileinput <?= $logo_exists ? 'fileinput-exists' : 'fileinput-new' ?>" data-provides="fileinput">
            <div class="fileinput-new thumbnail border border-slate-300 rounded-md bg-slate-50"
                style="width: 100px; height: 100px;"></div>
            <div class="fileinput-preview fileinput-exists thumbnail border border-slate-300 rounded-md overflow-hidden"
            ...
            <div class="mt-2">
                <span
                    class="btn btn-default btn-sm btn-file bg-white border border-slate-300 hover:bg-slate-50 text-slate-700 px-3 py-1.5 rounded-md shadow-sm transition-colors cursor-pointer inline-block">
                ...
                <a href="#"
                    class="btn btn-default btn-sm fileinput-exists bg-white border border-slate-300 hover:bg-slate-50 text-red-600 px-3 py-1.5 rounded-md shadow-sm transition-colors ms-2 no-underline"
