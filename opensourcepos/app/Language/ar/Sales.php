...
return [
    ...
    "check" => "تحويل بنكي",
    "check_balance" => "رصيد التحويل البنكي",
    "check_filter" => "تحويل بنكي",
    "close" => "",
    "comment" => "تعليق",
    "comments" => "تعليقات",
    "company_name" => "",
    ...
    "confirm_cancel_sale" => "هل أنت متأكد من الغاء عملية البيع ؟ سيتم إزالة كل المنتجات.",
    ...
    "credit_deposit" => "ايداع ببطاقة فيزا / ماستر كارد",
    "credit_filter" => "فيزا / ماستر كارد",
    "current_table" => "",
    "customer" => "العميل",
    ...
    "customer_optional" => "(مطلوب للدفعات الآجلة)",
    ...
    "employee" => "الموظف",
    "entry" => "ادخال",
    "error_editing_item" => "خطأ فى تحرير المنتج",
    "find_or_scan_item" => "بحث/مسح باركود المنتج",
    "find_or_scan_item_or_receipt" => "بحث/مسح باركود المنتج أو ايصال",
    "giftcard" => "بطاقة هدية",
    ...
    "item_insufficient_of_stock" => "لايوجد مخزون كافى من المنتج.",
    "item_name" => "اسم المنتج",
    "item_number" => "منتج #",
    "item_out_of_stock" => "لايوجد مخزون من المنتج.",
    ...
    "key_in" => "تكبير الصفحه",
    "key_item_search" => "بحث حسب المنتج",
    ...
    "no_filter" => "الكل",
    "no_items_in_cart" => "لايوجد منتجات فى السلة.",
    ...
    "quantity" => "الكمية",
    "quantity_less_than_reorder_level" => "تحذير: الكمية/العدد المطلوب غير متوفر لهذا المنتج.",
    "quantity_less_than_zero" => "تحذير! الكمية المطلوبة غير كافية، بإمكانك إتمام عملية البيع ، لكن تحقق من مخزنك.",
    "quantity_of_items" => "عدد {0} من المنتجات",
    "quote" => "عرض اسعار",
    ...
    "start_typing_item_name" => "ابداء بكتابة اسم أو مسح باركود المنتج...",
    "stock" => "المخزن",
    ...
    "unable_to_add_item" => "غير قادر على إضافة المنتج لعملية البيع",
    ...
    "sale_items_list" => "قائمة عناصر البيع",
    "select_customer_dialog" => "اختيار عميل",
    ...
    "close_dialog" => "إغلاق",
    "rename_category_success" => "تم إعادة تسمية الفئة بنجاح",
    "rename_category_error" => "فشل في إعادة تسمية الفئة",
    "category_name_required" => "اسم الفئة مطلوب",
    "category_already_exists" => "توجد فئة بهذا الاسم بالفعل",
    "confirm_delete_item" => "هل أنت متأكد من حذف هذا المنتج؟",
    "tabby" => "تابي",
    "tabby_filter" => "تابي",
    "tamara" => "تمارا",
    "tamara_filter" => "تمارا",
