...
return [
    ...
    "item" => "منتج",
    "item_count" => "تصفية عداد المنتج",
    "item_name" => "اسم المنتج",
    "item_number" => "باركود",
    "items" => "المنتجات",
    "items_purchased" => "المنتجات مشتراه",
    "items_received" => "المنتجات مستلمة",
    "items_summary_report" => "تقرير ملخص المنتجات",
    "jurisdiction" => "الاختصاص القضائي",
    "low_inventory" => "النواقص",
    "low_inventory_report" => "تقرير نواقص المخزون",
    "low_sell_quantity" => "كميات حسب المنتج الاولي",
    "more_than_zero" => "أكثر من صفر",
    "name" => "الاسم",
    "no_reports_to_display" => "لايوجد منتجات لعرضها.",
    ...
    "requisition_item" => "المنتج",
    "requisition_item_quantity" => "الكمية المطلوبة",
    "requisition_related_item" => "المنتج",
    ...
    "total_low_sell_quantity" => "مجموع الكميات حسب المنتج الاولي",
