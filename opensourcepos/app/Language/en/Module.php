...
return [
    ...
    "config_desc" => "Change system's Configuration.",
    "customers" => "Customers",
    ...
    "item_kits" => "Product Kits",
    "item_kits_desc" => "Add, Update, Delete and Search Product Kits.",
    "items" => "Products",
    "items_desc" => "Add, Update, Delete, and Search Products.",
    "messages" => "Messages",
    "messages_desc" => "Send Messages to Customers, Suppliers and Employees.",
    "migrate" => "Migrate",
    "migrate_desc" => "Update the system Database.",
    "office" => "Office",
