...
<div id="config_wrapper">
    <fieldset id="config_info">
        ...
        <div><?= lang('Common.fields_required_message') ?></div>
        ...
        <div class="form-group form-group-sm">
            <?= form_label(lang('Config.qz_enable'), 'qz_enable', ['class' => 'control-label col-xs-2']) ?>
            <div class="col-xs-1">
                <?= form_checkbox([
                    'name' => 'qz_enable',
                    'value' => 'qz_enable',
                    'id' => 'qz_enable',
                    'checked' => $config['qz_enable'] == 1
                ]) ?>
            </div>
        </div>

        <div class="form-group form-group-sm">
            <?= form_label(lang('Config.qz_printer_name'), 'qz_printer_name', ['class' => 'control-label col-xs-2']) ?>
            <div class="col-xs-6">
                <?= form_input([
                    'name' => 'qz_printer_name',
                    'id' => 'qz_printer_name',
                    'class' => 'form-control input-sm',
                    'value' => $config['qz_printer_name']
                ]) ?>
            </div>
        </div>
